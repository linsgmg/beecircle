...
public class NetworkUtils {
    ...
    public static boolean getDataEnabled() {
        try {
            ConnectivityManager tm = (ConnectivityManager) Utils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo mMobileNetworkInfo = tm.getNetworkInfo(ConnectivityManager.TYPE_MOBILE);
