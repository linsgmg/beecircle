...
public class PreferenceUtil {
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            try {
                ...
                if (type.equals(type_string)) {
                    ...
                    // sharedpreference没有保存double类型，所以先保存String，获取的时候再转成double
    ...
    public static Object getBeanValue(SharedPreferences sp, Class classType) {
            ...
            for (int i = 0; i < fields.length; i++) {
                ...
                try {
                    ...
                    if (type.equals(type_string)) {
                        ...
                        Method method = classType.getMethod("set" + upperName, boolean.class);
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            try {
                ...
                if (type.equals(type_string)) {
                    ...
                    boolean value = (boolean) methodO2.invoke(newBean);
                    Method method01 = classType.getMethod("set" + upperName, boolean.class);
                    method01.invoke(oldBean, value);
                    editor.putBoolean(name, value);
                }
                editor.commit();
            } catch (Exception e) {
