...
public class GridImageAdapter2 extends
    ...
    public GridImageAdapter2(Context context, onAddPicClickListener mOnAddPicClickListener, String text) {
        this.mInflater = LayoutInflater.from(context);
        this.mOnAddPicClickListener = mOnAddPicClickListener;
        this.text = text;
    }

    public GridImageAdapter2(Context context, onAddPicClickListener mOnAddPicClickListener, String text, int showDelete) {
        this.mInflater = LayoutInflater.from(context);
        this.mOnAddPicClickListener = mOnAddPicClickListener;
        this.text = text;
    ...
    public GridImageAdapter2(Context context, onAddPicClickListener mOnAddPicClickListener, String text, boolean addEnable) {
        this.mInflater = LayoutInflater.from(context);
        this.mOnAddPicClickListener = mOnAddPicClickListener;
        this.text = text;
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            viewHolder.mIvDel.setOnClickListener(view -> {
                ...
                if (null != mItemDelClickListener) {
                    mItemDelClickListener.onItemDelClick(index);
                }
            });
