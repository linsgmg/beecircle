...
import com.lin.baselib.widgt.klinechart.draw.KDJDraw;
import com.lin.baselib.widgt.klinechart.draw.MACDDraw;
import com.lin.baselib.widgt.klinechart.draw.MainDraw;
import com.lin.baselib.widgt.klinechart.draw.RSIDraw;
import com.lin.baselib.widgt.klinechart.draw.VolumeDraw;
import com.lin.baselib.widgt.klinechart.draw.WRDraw;
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (array != null) {
            try {
                ...
                //main
                setMa5Color(array.getColor(R.styleable.KLineChartView_kc_dif_color, getColor(R.color.chart_ma30)));
                setMa10Color(array.getColor(R.styleable.KLineChartView_kc_dea_color, getColor(R.color.chart_ma10)));
                setMa30Color(array.getColor(R.styleable.KLineChartView_kc_macd_color, getColor(R.color.chart_ma5)));
