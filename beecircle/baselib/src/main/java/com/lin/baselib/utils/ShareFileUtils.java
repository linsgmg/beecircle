...
public class ShareFileUtils {
    ...
    public static void shareImageToQQ(Context context, List<String> pathList) {
        ...
        shareImage(context, null, pathList, "com.tencent.mobileqq",
    ...
    public static void shareImageToQZone(Context context, String path) {
        ...
        shareImage(context, path, null, "com.tencent.mobileqq",
                "com.tencent.mobileqq/cooperation.qzone.share.QZoneShareActivity");

//        Tencent tencent = Tencent.createInstance("QQ_APP_ID", context); //要向腾讯平台申请appid
//        Bundle bundle = new Bundle();
//        bundle.putInt(QQShare.SHARE_TO_QQ_KEY_TYPE, QQShare.SHARE_TO_QQ_TYPE_IMAGE); //注意，要向qq空间分享纯图片，只能传这三个参数，不能传其他的
//        bundle.putString(QQShare.SHARE_TO_QQ_IMAGE_LOCAL_URL,path); //localImgUrl必须是本地手机图片地址
