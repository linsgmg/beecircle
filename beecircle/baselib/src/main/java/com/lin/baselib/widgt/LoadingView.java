...
/**
 * description: 用于显示 Loading 的 {@link View}，支持颜色和大小的设置。
 *
...
//        mSize = array.getDimensionPixelSize(R.styleable.LoadingView_loading_view_size, DisplayHelper.dp2px(context, 32));
        mSize = array.getDimensionPixelSize(R.styleable.LoadingView_loading_view_size, DensityUtil.dip2px(  getContext(),32));
