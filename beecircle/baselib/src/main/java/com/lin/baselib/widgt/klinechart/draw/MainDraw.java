...
//                    view.drawMainLine(canvas, ma10Paint, lastX, lastPoint.getMA60Price(), curX, curPoint.getMA60Price());
                ...
                if(lastPoint.getema12()!=0){
                    view.drawMainLine(canvas, ma5Paint, lastX, lastPoint.getema12(), curX, curPoint.getema12());
                }
                if(lastPoint.getema26()!=0){
                    view.drawMainLine(canvas, ma10Paint, lastX, lastPoint.getema26(), curX, curPoint.getema26());
